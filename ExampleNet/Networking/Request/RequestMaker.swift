...
public typealias NetworkResult<O: HandyJSON> = (Result<O, NetworkingError>)
...
//                }
            ...
            private func checkStatus<O: HandyJSON>(statusCode: Int, jsonString: NSString) -> NetworkResult<O> {
